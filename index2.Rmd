...
During the course we will allocate some time for each participant to work on a personal data, doing some manipulation and producing maps.  Please bring any spatial data that you are intersted working with. 
...
* Daily schedule (within the time contraint above): 09:00 - 17:30
* Lunch: 13:00 - 14:00
* Coffee: 11:00 - 11:20, 15:30 - 15:45
...
* [Data transformation](pre_transfomation.html) (EH)
...
* [Reproducable research in R?](pre_markdown.html) (EH) 
