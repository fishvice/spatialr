...
files <- c("./data_raw/Iceland_minbtemp.tif",
           "./data_raw/Iceland_maxbtemp.tif")
...
```{r }
capture.output(GDALinfo("./data_raw/Iceland_minbtemp.tif"))
...
rst <- temp[100:135, 50:85, drop = FALSE]
...
par(mfrow = c(1, 2))
plot(station_rst, main = "Number of stations")
