...
read_ices_shapes(url) %>% 
  rename_all(tolower) %>% 
  write_sf("/net/www/export/home/ftp/pub/data/shapes/nephrops_fu.gpkg")
...
read_ices_shapes(url) %>% 
  ...
  ms_simplify(keep = 0.05,
              snap = TRUE) %>% 
  write_sf("/net/www/export/home/ftp/pub/data/shapes/ices_areas.gpkg")
...
read_ices_shapes(url) %>% 
  ...
  ms_simplify(keep = 0.05,
              snap = TRUE) %>% 
  write_sf("/net/www/export/home/ftp/pub/data/shapes/ices_ecoregions.gpkg")
...
read_ices_shapes(url) %>% 
  rename_all(tolower) %>% 
  st_transform(crs = 4326) %>% 
  write_sf("/net/www/export/home/ftp/pub/data/shapes/ospar.gpkg")
...
read_ices_shapes(url) %>% 
  ...
  ms_simplify(keep = 0.05,
              snap = TRUE) %>% 
  write_sf("/net/www/export/home/ftp/pub/data/shapes/helcom.gpkg")
