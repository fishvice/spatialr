...
```
In the *ices_areas* object, the geometry type is a MULTIPOLYGON.  This is needed because even though individual ICES areas are continuous, often they contain islands.  The geometry of the islands is included, with the direction of points (clockwise or anticlockwise) indicating the topology.  
